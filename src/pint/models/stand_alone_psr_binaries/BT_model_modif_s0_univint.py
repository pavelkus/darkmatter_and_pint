...
def Rdm(Adm1, Adm2, Bdm, mdm, omegab, E):
    ...
    return  Adm1 * 2 * np.sin(Bdm + 0.5 * mdm/omegab * E) * np.sin(0.5 * mdm/omegab * E) + Adm2 * E / ( 360 * u.deg ) * 2 * np.pi
...
def d_Rdm_d_ADM1(Bdm, mdm, omegab, E):
    ...
    return 2 * np.sin(Bdm + 0.5 * mdm/omegab * E) * np.sin(0.5 * mdm/omegab * E)
